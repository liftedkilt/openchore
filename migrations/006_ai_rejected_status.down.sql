-- Revert: remove 'ai_rejected' from allowed status values.
-- Delete any ai_rejected rows first, then recreate with original constraint.
...
INSERT INTO chore_completions_old (id, chore_schedule_id, completed_by, status, photo_url, approved_by, approved_at, completed_at, completion_date, ai_feedback, ai_confidence)
