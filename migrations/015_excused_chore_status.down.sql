...
INSERT INTO chore_completions_old (id, chore_schedule_id, completed_by, status, photo_url, approved_by, approved_at, completed_at, completion_date, ai_feedback, ai_confidence, uncompleted_at)
    SELECT id, chore_schedule_id, completed_by, CASE WHEN status = 'excused' THEN 'approved' ELSE status END, photo_url, approved_by, approved_at, completed_at, completion_date, ai_feedback, ai_confidence, uncompleted_at
